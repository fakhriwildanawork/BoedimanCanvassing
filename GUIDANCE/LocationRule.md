...
0. **Frame Permissions (MANDATORY)**: Pastikan `metadata.json` memiliki `requestFramePermissions: ["geolocation"]` agar iframe (misalnya di AI Studio) mengizinkan prompt.
